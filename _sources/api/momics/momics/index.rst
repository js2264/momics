...
.. py:class:: Momics(path, config = None)
   ...
   .. py:method:: seq(label = None, one_hot = False)

      Extract sequence table from a `.momics` repository.

      :param label: Which chromosome to extract. Defaults to None.
      :type label: str, optional
      :param one_hot: Whether to return one-hot encoded array. Defaults to False.
      :type one_hot: bool, optional

      :returns:     - If label=None: A data frame listing one chromosome per row, with first/last 10 nts.
      ...
      :rtype: Union[pd.DataFrame, str, np.ndarray]
