...
.. py:class:: Momics(path, config = None)
   ...
   .. py:method:: bins(width, step, cut_last_bin_out=False)

      Generate a BedTool of tiled genomic bins

      :param width: The width of each bin.
      :type width: _type_
      :param step: The step size for tiling.
      :type step: _type_
   ...
   .. py:method:: features(label = None)
      ...
      :returns: A data frame listing one ingested features set per row
      :rtype: pd.DataFrame
