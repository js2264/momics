...
class Conv1DBlock(layers.Layer):
    """
    Custom layer that combines Conv1D, BatchNorm, Activation, Dropout, and optional MaxPooling.
    """
...
class DilatedConvBlock(layers.Layer):
    """
    Custom layer that combines dilated Conv1D, BatchNorm, Activation, Dropout, and optional MaxPooling.
    """
